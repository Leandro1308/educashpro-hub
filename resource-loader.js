(function(){
  "use strict";
  const loaded=new Map(),version="20260907.1";
  function script(src){
  ...
  function loadCourses(){return coursesPromise||(coursesPromise=series(["./technical-analysis-course.js","./business-21st-century-course.js","./course-final-notice.js","./video-course-access.js"]).catch(error=>{coursesPromise=null;throw error}))}
