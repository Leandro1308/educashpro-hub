(function(){
  ...
  function loadCourses(){return coursesPromise||(coursesPromise=series(["./technical-analysis-course.js","./video-course-access.js"]).catch(error=>{coursesPromise=null;throw error}))}
