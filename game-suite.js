(function () {
  ...
  function renderCatalog(options={}) {
    ...
    $("#createRaffle")?.addEventListener("click",()=>window.EduCashProSocial?.openRaffle?.({lang:requested}));
