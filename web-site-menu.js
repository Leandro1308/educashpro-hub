(function(){
  ...
  const COPY={
    pt:{menu:"Menu",title:"Menu EduCashPro",subtitle:"Recursos organizados por funcionalidade",close:"Fechar",login:"Entre na sua conta para acessar esta função.",groups:[
      ["Principal",[["home","🏠","Início"],["presentation","✨","Conheça o EduCashPro"]]],
      ...
      ["Negócios e oportunidades",[["marketplace","🏪","Marketplace"],["explore","🔎","Explorar projetos"],["benefits","🎁","Benefícios e parceiros"],["publish","🚀","Publicar projeto"],["projects","🗂️","Meus projetos"]]],
    ...
    en:{menu:"Menu",title:"EduCashPro Menu",subtitle:"Features organized by purpose",close:"Close",login:"Sign in to access this feature.",groups:[
      ["Main",[["home","🏠","Home"],["presentation","✨","Discover EduCashPro"]]],["Learning",[["learn","🎓","Academy"],["marketing","🤝","Marketing and Affiliates"],["finance","💰","Financial Education"],["telegram-course","✈️","Professional Telegram"]]],["Tools",[["tools","🧰","Tools"],["games","🎮","Free games"],["agenda","📅","Professional Schedule"],["link-page","🔗","Links page"],["smart-link","✂️","Smart Link"]]],["Business and opportunities",[["marketplace","🏪","Marketplace"],["explore","🔎","Explore projects"],["benefits","🎁","Benefits and partners"],["publish","🚀","Publish project"],["projects","🗂️","My projects"]]],["Account and subscription",[["account","👤","My account"],["subscription","💳","Subscription"],["credential","✅","My credential and QR Code"],["scan","📷","Scan credential"],["pair","📱","Connect another device"]]],["Affiliate program",[["affiliate","🔗","My affiliate link"],["network","📊","My network"]]],["Help and preferences",[["support","🆘","Support"],["language","🌐","Language"],["preferences","🔔","Notifications"],["documents","📄","About and Usage Policy"]]],["Telegram",[["telegram-app","✈️","Open App in Telegram"],["channel","📢","Official channel"],["group","👥","Official group"]]]
    ]},
    ...
    ru:{menu:"Меню",title:"Меню EduCashPro",subtitle:"Функции по разделам",close:"Закрыть",login:"Войдите в аккаунт, чтобы открыть эту функцию.",groups:[
      ["Главное",[["home","🏠","Главная"],["presentation","✨","О EduCashPro"]]],["Обучение",[["learn","🎓","Academy"],["marketing","🤝","Маркетинг и партнёры"],["finance","💰","Финансовое образование"],["telegram-course","✈️","Профессиональный Telegram"]]],["Инструменты",[["tools","🧰","Инструменты"],["games","🎮","Бесплатные игры"],["agenda","📅","Профессиональный календарь"],["link-page","🔗","Страница ссылок"],["smart-link","✂️","Умная ссылка"]]],["Бизнес и возможности",[["marketplace","🏪","Маркетплейс"],["explore","🔎","Проекты"],["benefits","🎁","Преимущества и партнёры"],["publish","🚀","Добавить проект"],["projects","🗂️","Мои проекты"]]],["Аккаунт и подписка",[["account","👤","Мой аккаунт"],["subscription","💳","Подписка"],["credential","✅","Моя карта и QR-код"],["scan","📷","Сканировать карту"],["pair","📱","Подключить устройство"]]],["Партнёрская программа",[["affiliate","🔗","Моя партнёрская ссылка"],["network","📊","Моя сеть"]]],["Помощь и настройки",[["support","🆘","Поддержка"],["language","🌐","Язык"],["preferences","🔔","Уведомления"],["documents","📄","О сервисе и правила"]]],["Telegram",[["telegram-app","✈️","Открыть приложение в Telegram"],["channel","📢","Официальный канал"],["group","👥","Официальная группа"]]]
    ]}
  };
  function lang(){const raw=String(document.documentElement.lang||navigator.language||"pt").toLowerCase();return raw.startsWith("en")?"en":raw.startsWith("es")?"es":raw.startsWith("ru")?"ru":"pt"}
