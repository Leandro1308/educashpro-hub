  ...
  function renderMath(level,requested,tournament){
    ...
    function frame(now){
      ...
      if(!paused&&!locked){
        ...
        y+=dt*(baseSpeed+Math.min(38,score/65))*factor/1000;q.style.top=`${y}px`;
